...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      style={{ position:'fixed', bottom:'24px', right:'24px', zIndex:9999, display:'flex', alignItems:'center', justifyContent:'center', width:'56px', height:'56px', borderRadius:'16px', background:'#25D366', boxShadow:'0 8px 28px rgba(37,211,102,0.45)', textDecoration:'none', transition:'transform 0.2s, box-shadow 0.2s' }}
    ...
    >
      {/* Ping animasyonu */}
      <span style={{ position:'absolute', inset:0, borderRadius:'16px', background:'#25D366', animation:'ping 2s cubic-bezier(0,0,0.2,1) infinite', opacity:0.3 }}></span>
      {/* WhatsApp logo SVG — resmi marka ikonu */}
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="30" height="30" style={{position:'relative', zIndex:1}}>
        <path fill="#fff" d="M4.868 43.303l2.694-9.835a18.76 18.76 0 01-2.513-9.388C5.054 13.514 13.911 4.655 24.976 4.655c5.362.003 10.395 2.093 14.179 5.882 3.785 3.789 5.87 8.826 5.867 14.187-.004 11.066-8.861 19.924-19.924 19.924-3.348 0-6.622-.857-9.496-2.48L4.868 43.303zm10.447-6.032a15.647 15.647 0 008.663 2.599c8.648.004 15.688-7.032 15.693-15.679.003-4.196-1.628-8.143-4.593-11.112-2.966-2.97-6.91-4.607-11.11-4.608-8.653-.004-15.693 7.032-15.698 15.681 0 2.958.813 5.838 2.357 8.334l-.363 1.329 1.366 4.986 3.685-.53zM32.25 27.31c-.12-.2-.44-.32-.92-.56-.48-.24-2.84-1.4-3.28-1.56-.44-.16-.76-.24-.96.24-.2.48-.84.96-1.4.96-.56.24-1.68-.12-2.84-1.2-1.08-1.04-1.84-2.36-2.04-2.84-.2-.48-.02-.74.16-.98.16-.2.36-.52.56-.76.2-.24.24-.44.4-.72.16-.24.08-.52-.04-.76-.12-.24-.96-2.32-1.32-3.16-.36-.84-.72-.72-.96-.72-.24-.04-.52-.04-.8-.04s-.76.12-1.16.52c-.4.4-1.52 1.48-1.52 3.64 0 2.16 1.56 4.24 1.76 4.52.2.28 2.88 4.68 7.16 6.36 1 .44 1.78.68 2.4.88.96.32 1.84.28 2.54.16.76-.12 2.36-.96 2.68-1.88.32-.92.32-1.72.24-1.88z"/>
      </svg>
    </a>
  );
};
